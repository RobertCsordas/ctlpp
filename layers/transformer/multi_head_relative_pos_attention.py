...
class FixedRelativeMultiheadAttentionBase(RelativeAttentionBase):
    def __init__(self, state_size: int, n_heads: int, dropout: float = 0.0, input_size: Optional[int] = None,
        ...
        self.register_buffer("pos_encoding", self._create_buffer(1000, self.pos_clamp))
        self.register_buffer("pos_encoding_test", self._create_buffer(1000, self.test_pos_clamp))
